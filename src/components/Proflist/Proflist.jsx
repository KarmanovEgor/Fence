...
export default function Proflist({ openPopup }) {
  ...
  const { alt, image, subtitle, text, title, titlePlus, montageTitle, montageText, montageImg, altShema, fenceData, kalitkaData, vorotaData } = proflist;
