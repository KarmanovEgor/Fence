...
const zaborImages = [
  ...
  {
    alt: "Откатные ворота под ключ",
    text: "Откатные ворота под ключ",
    way: "/vorota",
  },
];
...
const proflist = {
  ...
  text: "Профнастил является самым популярным материалом для создания ограждений. Покупателей привлекает не только стильное исполнение конструкции, но и высокое качество, долговечность, простой уход, доступная стоимость и другие преимущества. Для создания забора используют листы профнастила с цветным полимерным покрытием. Оно защищает материал от коррозии и позволяет подобрать листы, соответствующие общей концепции дизайна территории.",
